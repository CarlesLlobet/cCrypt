...
def cipher(key,keyLength):
	...
	addRoundKey(plainText, key[0:15])
	for i in range(0,nRounds.get(keyLength)):
		print "Ciphering: Loop " + str(i)
		subBytes()
		shiftRows()
		mixColumns()
		addRoundKey()
